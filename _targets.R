...
list(
  ...
  tar_target(
    rin_service_areas_geojson,
    write_data_to_geojson(rin_service_areas_sf, here::here("data/rin_service_areas.geojson")),
    format = "file"
  ),
  ...
  tar_target(
    ...
    {
      file_path <- here::here("data/rin_service_areas.parquet")
      st_write_parquet(obj = rin_service_areas_sf, dsn = file_path)
      file_path
    },
    format = "file"
  ),
